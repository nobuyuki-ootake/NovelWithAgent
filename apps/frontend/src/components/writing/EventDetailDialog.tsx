...
import {
  ...
  ListItemIcon,
  Paper,
  // IconButton, // 未使用のためコメントアウト
  // Grid, // 未使用のためコメントアウト
  // Accordion, // 未使用のためコメントアウト
} from "@mui/material";
import {
  Event as EventIcon,
...
// import CloseIcon from "@mui/icons-material/Close"; // 未使用のためコメントアウト
// import ExpandMoreIcon from "@mui/icons-material/ExpandMore"; // 未使用のためコメントアウト
