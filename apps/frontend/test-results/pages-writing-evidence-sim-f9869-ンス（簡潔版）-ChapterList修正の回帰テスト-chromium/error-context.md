...
- Name: 執筆機能エビデンス（簡潔版） >> ChapterList修正の回帰テスト
- Location: C:\Users\irure\git\NovelWithAgent\apps\frontend\e2e\pages\writing-evidence-simplified.spec.ts:79:3
...
Call log:
  - waiting for locator('div').filter({ hasText: /^テストプロジェクト作成日:.*更新日:.*$/ }).first()
    ...
    at C:\Users\irure\git\NovelWithAgent\apps\frontend\e2e\pages\writing-evidence-simplified.spec.ts:83:19
```
